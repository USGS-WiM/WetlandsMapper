    ...
    allLayers = [
        {
            ...
            'layers': {
                'Wetlands' : {
                    'url': 'http://52.70.106.103:6080/ArcGIS/rest/services/Wetlands/MapServer',
                    'options': {
                        'id': 'wetlands',
                        'opacity': 0.75,
                        'visible': true
                ...
                'Wetlands Status' : {
                    'url': 'http://52.70.106.103:6080/ArcGIS/rest/services/Wetlands_Status/MapServer',
                    'options': {
                        'id': 'wetlandsStatus',
                        'layers': [1],
                        'visible': true,
                ...
                'Wetlands Raster' : {
                    'url': 'http://52.70.106.103:6080/arcgis/rest/services/Wetlands_Raster/ImageServer',
                    'options': {
                        'id': 'wetlandsRaster',
                        'visible': true,
                        'maxScale': 285000,
                ...
                'Riparian' : {
                    'url': 'http://52.70.106.103:6080/ArcGIS/rest/services/Riparian/MapServer',
                    'visibleLayers': [0],
                    'options': {
                        'id': 'riparian',
                        'opacity': 0.75,
        ...
        },
        {
            ...
            'layers': {
                'Source Type':{
                    'url' : 'http://52.70.106.103:6080/arcgis/rest/services/Data_Source/MapServer',
                    'visibleLayers': [1],
                    'options':{
                        'id': 'sourceType',
                        'opacity': 0.6,
        ...
        },
        {
            ...
            'layers': {
                ...
                'Historic Wetland Data' : {
                    'url': 'http://52.70.106.103:6080/ArcGIS/rest/services/Historic_Wetlands/MapServer',
                    'visibleLayers': [0,1],
                    'options': {
                        'id': 'historic',
                        'visible': false,
